...
- [specs/self-hosted-install.md](./specs/self-hosted-install.md): self-hosted install, update, status, and domain operations.
...
- [specs/self-hosted-install.md](./specs/self-hosted-install.md): self-hosted install and operations contract.
