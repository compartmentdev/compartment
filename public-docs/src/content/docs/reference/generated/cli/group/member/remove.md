---
title: 'compartment group member remove'
description: 'Generated help output for compartment group member remove.'
---
...
```text
Usage: compartment group member remove [options] <groupId> <email>
