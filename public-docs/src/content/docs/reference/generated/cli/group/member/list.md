---
title: 'compartment group member list'
description: 'Generated help output for compartment group member list.'
---
...
```text
Usage: compartment group member list [options] <groupId>
