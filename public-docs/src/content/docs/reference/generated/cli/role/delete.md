---
title: 'compartment role delete'
description: 'Generated help output for compartment role delete.'
---
...
```text
Usage: compartment role delete [options] <roleId>

Options:
  --output <format>  text or json (default: "text")
  --yes              confirm role deletion
  --remote <name>
