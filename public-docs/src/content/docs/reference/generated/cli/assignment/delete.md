---
title: 'compartment assignment delete'
description: 'Generated help output for compartment assignment delete.'
---
...
```text
Usage: compartment assignment delete [options] <assignmentId>
