---
title: 'compartment system restart'
description: 'Generated help output for compartment system restart.'
---
...
```text
Usage: compartment system restart [options]

Restart platform workloads and wait for their rollout
