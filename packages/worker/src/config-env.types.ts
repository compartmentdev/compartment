...
export interface WorkerBuildConfigEnvironment extends WorkerProcessConfigEnvironment {
  ...
  COMPARTMENT_BUILDKIT_SEED_IMAGE: string;
  COMPARTMENT_BUILDKIT_SEED_CACHE_IMAGE: string;
  COMPARTMENT_BUILDKIT_SEED_CACHE_MANIFEST_URL: string;
  ...
  COMPARTMENT_RAILPACK_BUILDER_IMAGE: string;
  COMPARTMENT_RAILPACK_RUNTIME_IMAGE: string;
}
