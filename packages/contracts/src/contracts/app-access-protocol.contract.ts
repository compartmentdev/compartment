...
export const compartmentIngressRoutePathname: string = '/internal/ingress/route';
export const compartmentIngressRouteResolvedHeaderName: string = 'X-Compartment-Ingress-Route-Resolved';
