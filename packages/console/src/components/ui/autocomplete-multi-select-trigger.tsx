...
function AutocompleteMultiSelectTriggerBadge({
  ...
  return (
    <Badge
      className="h-5 max-w-full min-w-0 rounded-pill border border-[var(--cpt-border-default,rgba(0,0,0,0.08))] bg-background px-1.5 py-0 text-[11px] font-medium leading-4"
      variant="outline"
    >
