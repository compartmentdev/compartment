...
CREATE TABLE "deployment_custom_domains" (
	...
	"reconcile_state" text DEFAULT 'pending' NOT NULL,
	"desired_generation" integer DEFAULT 1 NOT NULL,
	"observed_generation" integer DEFAULT 0 NOT NULL,
	"observed_ingress_present" boolean DEFAULT false NOT NULL,
	"observed_certificate_present" boolean DEFAULT false NOT NULL,
	"observed_certificate_ready" boolean DEFAULT false NOT NULL,
	"edge_routing_enabled" boolean DEFAULT false NOT NULL,
	"deletion_ready" boolean DEFAULT false NOT NULL,
...
CREATE TABLE "deployments" (
	...
	"resolved_ports_json" text DEFAULT '[3000]' NOT NULL,
...
CREATE TABLE "product_job_runs" (
	...
	"runtime_identity" text DEFAULT 'resource' NOT NULL,
...
CREATE TABLE "project_kube_provisioning" (
	...
	"isolation_version" integer DEFAULT 0 NOT NULL,
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	"updated_at" timestamp with time zone DEFAULT now() NOT NULL
);
--> statement-breakpoint
...
CREATE TABLE "resource_backups" (
	...
	"retention_failure_summary" text,
	"retention_next_attempt_at" timestamp with time zone,
