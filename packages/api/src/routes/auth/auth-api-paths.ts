export {
  ...
  compartmentAuthLoginDiscoveryPathname as authApiLoginDiscoveryPathname,
  compartmentAuthLoginPathname as authApiLoginPathname,
  compartmentAuthLoginStatePathname as authApiLoginStatePathname,
