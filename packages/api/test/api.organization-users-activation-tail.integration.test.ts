...
const {
  ...
  'api_integration_organization_users_activation_tail',
  'api-integration-organization-users-activation-tail',
);
let pool!: Pool;
let db!: Database;
let app!: ApiApp;
...
describe('Phase 0 API integration organization users activation tail', (): void => {
