...
describe('self-hosted environment helpers', (): void => {
  it('renders the self-hosted environment with generated image refs and secrets', (): void => {
    ...
    expect(rendered.values.COMPARTMENT_ARTIFACT_REGISTRY_INTERNAL_URL).toBe('http://registry-auth:5000');
    expect(rendered.values.COMPARTMENT_ARTIFACT_REGISTRY_MODE).toBe('bundled');
