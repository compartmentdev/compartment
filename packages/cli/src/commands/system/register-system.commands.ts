...
import { registerKubernetesSystemLifecycleCommands } from './lifecycle.command';
import { registerRegistryMirrorSystemCommands } from './registry-mirror.command';
...
export function registerSystemCommands(program: Command, dependencies: CliCommandDependencies): void {
  ...
  registerKubernetesSystemLifecycleCommands(system, dependencies);
  registerRegistryMirrorSystemCommands(system, dependencies);
}
