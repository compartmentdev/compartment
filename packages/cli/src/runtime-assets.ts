...
export function buildStagedAssetPathCandidates(configDir: string, dataDir: string): readonly StagedAssetPaths[] {
  return [buildStagedAssetPaths(configDir, dataDir), buildLegacyStagedAssetPaths(configDir, dataDir)];
}
